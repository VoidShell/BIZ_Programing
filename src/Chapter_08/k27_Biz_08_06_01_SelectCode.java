...
public class k27_Biz_08_06_01_SelectCode {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ParseException {
        ...
        File f1 = new File("StockDailyPrice_SelectCode.csv");
        ...
        while ((readtxt = br.readLine()) != null) {
            ...
            if (field.length > 2 && field[2].replace("^", "").trim().substring(0, 1).equals("A")) {
                ...
                wcnt += selectStock(refineField[CODE_FIELD_NUM], STOCK_CODE, bw1, s.toString());
            }
            cnt++;
        }
